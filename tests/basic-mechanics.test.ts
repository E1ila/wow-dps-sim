...
describe('Attack Table Mechanics', () => {
  ...
  describe('Dual-Wield Miss Calculation', () => {
    it('should calculate DW miss as (base_miss × 0.8) + 20% with 300 skill', () => {
      ...
      const baseMissNoHit = 0.05 + (defenseSkillDiff * 0.001);
  ...
  describe('Hit Cap Verification', () => {
    describe('300 weapon skill', () => {
      it('should have correct miss chances with varying hit percentages', () => {
        ...
        const testCases = [
          ...
          { hitPercent: 3, expectedMissMin: 23, expectedMissMax: 24 },
          { hitPercent: 6, expectedMissMin: 20, expectedMissMax: 21 },
          { hitPercent: 9, expectedMissMin: 17, expectedMissMax: 18 },
        ];
    ...
    describe('305 weapon skill', () => {
      it('should have correct miss chances with varying hit percentages', () => {
        ...
        const testCases = [
          ...
          { hitPercent: 3, expectedMissMin: 21, expectedMissMax: 22 },
          { hitPercent: 6, expectedMissMin: 18, expectedMissMax: 19 },
          { hitPercent: 9, expectedMissMin: 15, expectedMissMax: 16 },
        ];
    ...
    describe('308 weapon skill', () => {
      it('should have correct miss chances with varying hit percentages', () => {
        const skill = 308;
        const testCases = [
          { hitPercent: 0, expectedMissMin: 23, expectedMissMax: 24 },
          { hitPercent: 3, expectedMissMin: 20, expectedMissMax: 21 },
          { hitPercent: 6, expectedMissMin: 17, expectedMissMax: 18 },
          { hitPercent: 9, expectedMissMin: 14, expectedMissMax: 15 },
        ];
