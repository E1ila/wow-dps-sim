...
export enum WeaponEnchant {
   None = 'None',
   Crusader = 'Crusader',
   FieryWeapon = 'Fiery Weapon',
   IcyChill = 'Icy Chill',
   Lifestealing = 'Lifestealing',
   UnholyWeapon = 'Unholy Weapon',
   Dmg1 = '+1 Damage (Minor Striking)',
   Dmg2 = '+2 Damage (Striking)',
   Dmg3 = '+3 Damage (Greater Striking)',
   Dmg4 = '+4 Damage',
   Dmg5 = '+5 Damage (Superior Striking)',
   Agility15 = '+15 Agility',
   Agility25 = '+25 Agility',
   SpellPower = '+30 Spell Power',
   HealingPower = '+55 Healing Power',
}

export const WEAPON_ENCHANT_SPELL_IDS: { [key: number]: WeaponEnchant } = {
   20034: WeaponEnchant.Crusader,
   13898: WeaponEnchant.FieryWeapon,
   20029: WeaponEnchant.IcyChill,
   20032: WeaponEnchant.Lifestealing,
   20033: WeaponEnchant.UnholyWeapon,
   7788: WeaponEnchant.Dmg1,
   13693: WeaponEnchant.Dmg2,
   13943: WeaponEnchant.Dmg3,
   20031: WeaponEnchant.Dmg5,
   23800: WeaponEnchant.Agility15,
   27837: WeaponEnchant.Agility25,
   22749: WeaponEnchant.SpellPower,
   22750: WeaponEnchant.HealingPower,
};
